...
const expandMore = `<svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48" fill="var(--slate-400)">
  ...
  6.909-14.694 10.455Q488.778 713 479.889 713Z"/></svg>`; // manually has gray fill color
...
698q-14 13-33 13t-32-13L480 533 315 700q-13 13-31.5 12.5T251 699Z"/></svg>`; // manually has blue fill color
let active = true;
